...
parser.add_argument('--games', type=int, default=6, help='no of episodes')
...
def transfer_and_train(agent_models, agent_buffers, num_games, env, eval_env):
    ...
    for agent_name in env.agents: 
        ...
        model.load(f"source_agent_{agent_name}","", input_obs_dim, conv_input_dim, new_action_dim, old_action_dim, agent_opt.lr, agent_opt.transfer_train)
        agent_models.append(model)
